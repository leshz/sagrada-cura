              ...
              <div className="product-card-content">
                <h6>
                  <Link legacyBehavior href="/shop/product-default">
                    <a className="hover-underline">Botanical hair Shampoo </a>
                  </Link>
                </h6>
                <p>
                  <Link legacyBehavior href="/shop">
                ...
                <div className="overlay">
                  <div className="cart-area">
                    <Link legacyBehavior href="/shop/out-of-stock">
                      <a className="hover-btn3 add-cart-btn ">Request Stock</a>
                    </Link>
                  </div>
                </div>
                <div className="view-and-favorite-area">
                ...
                <div className="overlay">
                  <div className="cart-area">
                    <Link legacyBehavior href="/product-with-size-variation">
                      <a className="hover-btn3 add-cart-btn">Select options</a>
                    </Link>
                  </div>
                </div>
                <div className="view-and-favorite-area">
          ...
          <div className={`col-md-4`}>
            <div className="product-card style-3 hover-btn">
              ...
              <div className="product-card-content">
                <h6>
                  <Link legacyBehavior href="/shop/product-default">
                    <a className="hover-underline">Eau de perfume for women</a>
                  </Link>
                </h6>
                <p>
                  <Link legacyBehavior href="/shop">
          ...
          <div className={`col-md-4`}>
            <div className="product-card style-3 hover-btn">
              ...
              <div className="product-card-content">
                <h6>
                  <Link legacyBehavior href="/shop/product-default">
                    <a className="hover-underline">curology face cleanser</a>
                  </Link>
                </h6>
                <p>
                  <Link legacyBehavior href="/shop">
          ...
          <div className={`col-md-4`}>
            <div className="product-card style-3 hover-btn">
              ...
              <div className="product-card-content">
                <h6>
                  <Link legacyBehavior href="/shop/product-default">
                    <a className="hover-underline">Coconut balm skin salve</a>
                  </Link>
                </h6>
                <p>
                  <Link legacyBehavior href="/shop">
          ...
          <div className={`col-md-4`}>
            <div className="product-card style-3 hover-btn">
              ...
              <div className="product-card-content">
                <h6>
                  <Link legacyBehavior href="/shop/product-default">
                    <a className="hover-underline">Vitamin c face cleanser</a>
                  </Link>
                </h6>
                <p>
                  <Link legacyBehavior href="/shop">
          ...
          <div className={`col-md-4`}>
            <div className="product-card style-3 hover-btn">
              ...
              <div className="product-card-content">
                <h6>
                  <Link legacyBehavior href="/shop/product-default">
                    <a className="hover-underline">bleu chanel de perfume</a>
                  </Link>
                </h6>
                <p>
                  <Link legacyBehavior href="/shop">
