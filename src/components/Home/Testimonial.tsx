        ...
        <div className="say-about-wrapper">
          <div className="row">
            <div className="col-lg-12">
              <Swiper
                {...testimonialSlideSettings}
                className="swiper say-about-slider"
              >
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="say-about-card">
                      ...
                      <p>
                        “I was recommended snaga from a dear friendest onest
                        Gives energy, strength &amp; mostly youm motivationt
                        goint and WOW!!! Gives energy, strength &amp; mostlydat
                        youm motivation”
                      </p>
                      <div className="say-about-card-bottom">
                        <div className="author-area">
                          <div className="author-img">
                            <img
                              src="/assets/img/home2/testimonial-author-img1.png"
                              alt=""
                            />
                          </div>
                    ...
                    <div className="say-about-card">
                      ...
                      <div className="say-about-card-bottom">
                        <div className="author-area">
                          <div className="author-img">
                            <img
                              src="/assets/img/home2/testimonial-author-img2.png"
                              alt=""
                            />
                          </div>
                          <div className="author">
                    ...
                    <div className="say-about-card">
                      ...
                      <div className="say-about-card-bottom">
                        <div className="author-area">
                          <div className="author-img">
                            <img
                              src="/assets/img/home2/testimonial-author-img3.png"
                              alt=""
                            />
                          </div>
                          <div className="author">
