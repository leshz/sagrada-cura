        ...
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-8">
            ...
            <div className="blog-content">
              ...
              <p>
                Mauris et enim magna. Quisque ornare vitae nibh eget tincidunt.
                In purus orci, iaculis iaculis turpis europeat, molestie rhoncus
                turpis. Nullam at urna bibendum, vulputate purus non, facilisis
                turpis. Mauris sit amet semle vitae neque condimentum viverra ut
                sed massa. Phasellus tortor arcu, placerat vel odio quis,
                commodo offert pellentesque leo. Cras mollis tempus risus sit
                amet pellentesque. Nam et augue faucibus, consequat turpison
              ...
              <blockquote>
                <p>
                  Mauris et enim magna quisque ornaret vitae nibbah egeto
                  tincidunt. In purus orci, iaculis iaculis turpis european nori
                  wordless more than work.
                </p>
              </blockquote>
                ...
                <div className="row g-4">
                  <div className="col-lg-6">
                    <div className="blog-details-img">
                      <img
                        src="/assets/img/inner-page/blog-details-group-img1.png"
                        alt=""
                      />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="blog-details-img">
                      <img
                        src="/assets/img/inner-page/blog-details-group-img2.png"
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div className="blog-details-navigation">
              ...
              <div className="single-navigation two">
                ...
                <div className="content">
                  ...
                  <h4>
                    <Link legacyBehavior href="/blog-details">
                      <a>Vestibulum eu sapien velit</a>
                    </Link>
                  </h4>
                </div>
              </div>
