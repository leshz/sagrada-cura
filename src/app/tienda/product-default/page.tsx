            ...
            <div className="col-lg-6">
              <div className="shop-details-content">
                ...
                <p>
                  ...
                  per inceptos only placerat felis non aliquam.Mauris nec justo
                  vitae ante auctor tol euismod sit amet Praesent commodo at
                ...
                <div className="shop-details-btn">
                  <Link legacyBehavior href="/shop/cart">
                    <a className="primary-btn1 hover-btn3">*Add to Cart*</a>
                  </Link>
                  <Link legacyBehavior href="/checkout">
                    <a className="primary-btn1 style-3 hover-btn4">*Buy Now*</a>
                  </Link>
                </div>
                    ...
                    <div className="row gy-5">
                      ...
                      <div className="col-lg-6 d-flex align-items-center justify-content-center">
                        <div className="description-tab-img">
                          <img
                            src="/assets/img/inner-page/shop-details-description-img.png"
                            alt=""
                          />
                        </div>
                      </div>
